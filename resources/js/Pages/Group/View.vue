...
const thumbnailUrl = computed(() => {
  return (
    thumbnailImageSrc.value ||
    props.group.thumbnail_url ||
    '/assets/icons/people.svg'
  );
});

watch(thumbnailUrl, (newValue) => {
  console.log("Group thumbnail path:", newValue);
});
    ...
    <div class="max-w-[768px] mx-auto h-full overflow-auto">
      <div class="px-4">
        ...
        <div class="group relative bg-white dark:bg-slate-950 dark:text-gray-100">
          <img
            :src="coverImageSrc || group.cover_url || '/assets/icons/achtergrond.jpg'"
          ...
          <div class="flex">
            ...
            >
              <img
                ...
                @error="$event.target.src = '/assets/icons/people.svg'"
              />
              <button
