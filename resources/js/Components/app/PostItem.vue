            ...
            <div class="flex gap-2">
                <button
                    ...
                    post.current_user_has_reaction ?
                     ...
                     'bg-gray-100 dark:bg-black dark:hover:bg-slate-800 '
                ]"
                >
                ...
                <DisclosureButton
                    class="text-gray-800 dark:text-gray-100 flex gap-1 items-center justify-center bg-gray-100 dark:bg-black dark:hover:bg-slate-800 rounded-lg hover:bg-gray-200  py-2 px-4 flex-1"
                >
