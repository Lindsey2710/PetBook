...
<template>
    <div class="h-full overflow-hidden flex flex-col bg-gray-100 dark:bg-black">
        <nav class="bg-white dark:bg-black border-b border-gray-100 dark:border-black mb-20">
                            ...
                            <Dropdown v-if="authUser" align="right" width="48">
                                <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 ring-2 text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-black hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150"
                                            >
                                                {{ authUser.name }}
